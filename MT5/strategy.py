...
timeframe = "1m" 
candles = 1000 
symbols = ["EURUSD"] # , "USDJPY", "USDCHF", "EURJPY", "GBPJPY"] # get_all_symbols() # 
...
def get_ai_trade_signal(symbol, current_price, data):
    ...
    sys_prompt = f"""
        ...
        don't forget to add the % to the confidence result. and you can only return a dict without enclosing in " or anything
        but note that those keys are strings
        """
