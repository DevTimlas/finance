...
def run_autoencoder_stock_prediction(data_file):
    ...
    prediction_model.fit(X_train_encoded, y_train, epochs=10, batch_size=32, validation_data=(X_test_encoded, y_test))
    ...
    return (('Train Mean Squared Error:', mse_train), ('Test Mean Squared Error:', mse_test), ('Train R-squared:', r2_train), ('Test R-squared:', r2_test))

run_autoencoder_stock_prediction("ml_data.csv")